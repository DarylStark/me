<template>
    <div class='client'>
        <me-flexline class='client_title'>
            ...
            <div>
                <me-button primary v-bind:disabled='loading' v-bind:loading='loading' v-on:click='add_token'>Add user token</me-button>
            </div>
        </me-flexline>
        <me-userprofile-api-user v-bind:key='user_token.id' v-bind:user_token='user_token' v-for='user_token in client.user_tokens'></me-userprofile-api-user>
    </div>
</template>
