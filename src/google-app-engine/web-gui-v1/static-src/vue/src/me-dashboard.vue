    ...
    created: function() {
            ...
            .then(function(data) {
                ...
                if (data['data']['object']['description'] == null) {
                    $('body').toast({
                        position: 'bottom center',
                        message:
                            'This session has no name yet. You can set a name for this session on your user profile.',
                        closeIcon: true,
                        displayTime: 'auto',
                        showIcon: 'user'
                    });
                ...
                // client API
                vue_this.$store.state.app.loading_text =
        ...
        jquery(window).click(function(event) {
            ...
            if (document.getElementById('me-dashboard-main-menu') != null) {
                if (
                    document
                        .getElementById('me-dashboard-content')
                        .contains(event.target) &&
                    (vue_this.$store.state.ui.media_type == 'phone' ||
                        vue_this.$store.state.ui.media_type == 'tablet')
                ) {
