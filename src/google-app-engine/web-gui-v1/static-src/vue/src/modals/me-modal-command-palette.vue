<template>
    <me-modal id='modal_command_palette' ref='modal' v-bind:centered='false' v-bind:content='false' v-on:hidden='reset' v-on:showing='init'>
        <div class='ui fluid search'>
            <input class='prompt' placeholder='Enter a command' ref='q' type='text' v-model='query' />
                ...
                templates: {
                    cmdpalette: function(response) {
                        ...
                        response.results.forEach(function(element) {
                            let response_div =
                                '<a class="result"><div class="content"><div class="title"><i class="' +
                                element.icon +
                                ' icon"></i> ' +
                                element.title +
